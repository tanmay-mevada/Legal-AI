...
export default function Navbar({ user }: { user: import("firebase/auth").User | null }) {
  return (
    <nav className="relative z-50 border-b border-dark-800/50 glass-morphism">
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-xl font-bold text-gradient">Legal AI</div>
        </div>
          ...
          {user && (
            <>
              <div className="flex items-center space-x-3">
                ...
                <span className="hidden font-medium text-dark-200 sm:block">
