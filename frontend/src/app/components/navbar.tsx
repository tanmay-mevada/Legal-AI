    ...
    <nav className="relative z-50 border-b border-slate-200/80 dark:border-dark-800/50 glass-morphism bg-white/50 dark:bg-transparent">
      <div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="text-lg sm:text-xl font-bold text-slate-900 dark:text-gradient">Legal AI</div>
        </div>
          ...
          {user && (
            <>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-primary-500 to-electric-400">
                  <span className="text-xs sm:text-sm font-semibold text-white">
                    {user.displayName?.charAt(0) || user.email?.charAt(0) || 'U'}
                  </span>
                </div>
                <span className="hidden font-medium text-slate-700 dark:text-dark-200 md:block text-sm sm:text-base">
